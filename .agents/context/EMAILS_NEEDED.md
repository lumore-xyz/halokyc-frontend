...
- [x] **Payment Success / Invoice (Dodo-owned)**: Dodo generates and emails the
      invoice for successful purchases/renewals and exposes PDF downloads in
      its customer portal. HaloKYC must not send a duplicate SMTP receipt.
...
- `contact@halokyc.com` — General inquiries and sales.
- `info@halokyc.com` — General inquiries and sales.
...
- `noreply@halokyc.com` — Automated system notifications.
- `verify@halokyc.com` — Automated OTP sender.
