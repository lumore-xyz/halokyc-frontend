...
export function CodeBlock({
  ...
  return (
<div className={cn("w-full rounded-lg border overflow-y-hidden overflow-x-auto", className)}>
...
export function MultiFileCodeBlock({
  ...
  return (
    <div className={cn("rounded-lg border overflow-y-hidden overflow-x-auto", className)}>
