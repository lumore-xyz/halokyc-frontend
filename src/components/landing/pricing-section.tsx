            ...
            <Reveal key={plan.name} delay={0.05 * i}>
              ...
              >
                ...
                <div className="flex items-baseline justify-between gap-4">
                  ...
                  {plan.highlight ? (
                    <span className="font-mono text-[10px] tracking-[0.22em] text-[var(--landing-cyan)] uppercase">
                      Featured
                    </span>
                  ) : null}
                </div>

                <p className="font-display mt-4 text-3xl font-semibold tracking-tight text-[var(--landing-canvas-ink)]">
                  {plan.name}
                </p>
