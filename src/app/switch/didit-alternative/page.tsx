...
const REASONS = [
  {
    label: "More free usage",
    title: "Test twice as many verifications before paying.",
    body: "HaloKYC includes 1,000 Sandbox credits each month. Didit publishes 500 free Full KYC sessions each month, then charges $0.33 for that bundle.",
  },
  {
    label: "One credit, one decision",
    title: "Keep the bill stable when you add checks.",
    body: "A completed HaloKYC verification uses one credit whether the workflow runs one check or combines OCR, liveness, face match, age, and duplicate detection. Didit meters the modules that execute.",
  },
  {
    label: "Repeat-user controls",
    title: "Treat duplicate identities as an operating problem.",
    body: "HaloKYC brings tenant-scoped duplicate matching, subject bans, manual review, and the audit trail into the same focused workflow for teams fighting repeat-account abuse.",
  },
  {
    label: "Platform-independent delivery",
    title: "Use the same KYC integration in every app.",
    body: "Your backend creates a session through the REST API. Web, Android, and iOS apps open the hosted flow, while the result returns through the API or a signed webhook.",
  },
] as const;
...
const COMPARISON_ROWS = [
  {
    ...
    didit: "Teams that want broad global identity and fraud infrastructure",
  },
  {
    feature: "Free monthly usage",
    halo: "1,000 Sandbox credits",
    didit: "500 Full KYC sessions",
  },
  {
    feature: "Published paid entry",
    halo: "$49/month for 1,500 credits; effective $0.033 per credit",
    didit: "$0.33 per Full KYC session after the free allowance",
  },
  {
    feature: "Billing unit",
    halo: "One completed verification uses one credit, independent of configured checks",
    didit: "Charges for the modules that execute in a workflow",
  },
  {
    feature: "Identity workflow",
    halo: "OCR, liveness, face match, age, duplicate detection, and decision rules",
    didit: "25+ published modules across identity, biometrics, AML, KYB, transactions, and wallets",
  },
  {
    feature: "Repeat-user abuse",
    halo: "Tenant-scoped duplicate matching, subject bans, review, and audit history",
    didit: "Duplicate detection, blocklisted users, device signals, and reusable KYC",
  },
  {
    feature: "App integration",
    halo: "REST API plus hosted flow for web, Android, iOS, or any connected client",
    didit: "REST API, hosted flow, and SDKs for web and mobile stacks",
  },
  {
    feature: "Result delivery",
    halo: "API polling and HMAC-signed webhooks",
    didit: "API decision retrieval and signed webhooks",
  },
] as const;

const FAQS = [
  {
    question: "Is HaloKYC a drop-in replacement for Didit?",
    answer:
      "No. Both products use workflows, sessions, hosted verification, and webhooks, but their endpoints, status values, signatures, and billing models differ. Plan a small integration change rather than swapping credentials.",
  },
  {
    question: "When should I stay with Didit?",
    answer:
      "Stay with Didit if you need its advertised global document coverage, native SDK catalog, reusable identity network, KYB, transaction monitoring, wallet screening, or broader fraud modules. HaloKYC is the narrower option for focused KYC and repeat-user controls.",
  },
  {
    question: "Is HaloKYC cheaper than Didit?",
    answer:
      "For HaloKYC's published plans, the effective paid rate is $0.020 to $0.033 per completed verification, and the Sandbox includes 1,000 credits each month. Didit publishes 500 free Full KYC sessions each month and $0.33 per Full KYC session after that. The bundles are not identical, so compare the checks your workflow actually runs.",
  },
  {
    question: "Can I test HaloKYC before switching?",
    answer:
      "Yes. Rebuild one representative workflow in a Sandbox workspace and run it beside Didit. Compare completion, false rejects, manual-review volume, duplicate outcomes, webhook handling, and the final cost before moving production traffic.",
  },
  {
    question: "Can HaloKYC run in an Android or iOS app?",
    answer:
      "Yes. Your backend creates the verification session through the REST API, and your Android, iOS, or web app opens the hosted verification flow. The decision is available through the API and signed webhooks, so the KYC integration is not tied to one client platform.",
  },
  {
    question: "What does one HaloKYC credit include?",
    answer:
      "One credit pays for one completed verification. The cost stays at one credit whether the workflow runs one check or combines liveness, OCR, face match, age, and duplicate detection.",
  },
] as const;
...
export const metadata: Metadata = {
  title: "Didit alternative for startup KYC",
  description:
    "Compare HaloKYC and Didit across free usage, paid pricing, duplicate controls, workflows, and platform-independent web and mobile integration.",
  metadataBase: new URL(publicEnv.siteUrl),
  alternates: {
    canonical: "/switch/didit-alternative",
  },
  openGraph: {
    title: "A focused Didit alternative for startup KYC | HaloKYC",
    description:
      "An honest comparison of HaloKYC and Didit for product teams choosing identity verification infrastructure.",
    type: "website",
    url: "/switch/didit-alternative",
    siteName: "HaloKYC",
  },
};
...
export default function DiditAlternativePage() {
  return (
    <MarketingPageShell>
      <script
      ...
      <section className="relative isolate overflow-hidden border-b border-(--landing-hair)">
        ...
        <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center px-6 py-20 text-center sm:px-8 sm:py-28 lg:px-10 lg:py-32">
          ...
          <h1 className="font-display mt-7 max-w-5xl text-5xl leading-[0.98] font-medium tracking-[-0.045em] text-(--landing-canvas-ink) sm:text-6xl lg:text-7xl">
            Didit covers more. HaloKYC keeps KYC focused.
          </h1>
          <p className="mt-7 max-w-3xl text-base leading-7 text-(--landing-canvas-ink-soft) sm:text-lg">
            Choose HaloKYC when you need predictable per-verification pricing,
            repeat-user controls, and one platform-independent integration for
            web, Android, and iOS apps—not a wider identity and fraud platform.
          </p>
          ...
          <div className="mt-16 grid w-full max-w-5xl overflow-hidden rounded-xl border border-(--landing-hair) bg-(--landing-canvas-edge) text-left sm:grid-cols-[1fr_auto_1fr] sm:items-stretch">
            <div className="flex flex-col justify-between gap-8 p-6 sm:p-8">
              ...
              <div>
                <p className="font-display text-4xl font-medium tracking-[-0.04em] text-(--landing-cyan)">
                  1,000
                </p>
                <p className="mt-2 text-sm leading-6 text-(--landing-canvas-ink-soft)">
                  free Sandbox credits every month
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between gap-8 p-6 sm:p-8">
              <Image
                src="/assets/logo/didit.svg"
                alt="Didit"
                width={795}
                height={265}
                className="h-9 w-auto max-w-32 brightness-0 invert"
              />
              <div>
                <p className="font-display text-4xl font-medium tracking-[-0.04em]">
                  500
                </p>
                <p className="mt-2 text-sm leading-6 text-(--landing-canvas-ink-soft)">
                  free Full KYC sessions every month
                </p>
              </div>
            </div>
          </div>
          <p className="mt-5 max-w-3xl text-xs leading-5 text-(--landing-canvas-mute)">
            Free allowances are not a like-for-like product bundle. HaloKYC is
            not affiliated with Didit; confirm current details with each vendor.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-20 sm:px-8 sm:py-28 lg:grid-cols-[0.72fr_1.28fr] lg:px-10">
          <div>
            ...
            <h2 className="font-display mt-5 max-w-xl text-4xl leading-tight font-medium tracking-[-0.035em] sm:text-5xl">
              Buy the KYC stack you need now.
            </h2>
            <p className="mt-5 max-w-lg text-[15px] leading-7 text-(--landing-ink-soft)">
              Didit is building a broad identity and fraud platform. HaloKYC is
              the focused option for teams that need to verify people, stop
              repeat users, and keep the operating model easy to explain.
            </p>
          </div>
      ...
      <section
        id="comparison"
        aria-labelledby="didit-comparison-heading"
      ...
      >
        <div className="mx-auto w-full max-w-7xl px-6 py-20 sm:px-8 sm:py-28 lg:px-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2
              id="didit-comparison-heading"
              className="font-display mt-5 text-4xl leading-tight font-medium tracking-[-0.035em] sm:text-5xl"
            >
              HaloKYC vs Didit, without pretending they are identical.
            </h2>
            <p className="mt-5 text-[15px] leading-7 text-(--landing-canvas-ink-soft)">
              Both products can run a hosted identity flow. Didit offers the
              broader catalog; HaloKYC offers a smaller operating surface and a
              fixed credit for each completed verification.
            </p>
          </div>
          ...
          <div className="mt-6 flex flex-col gap-3 text-xs leading-5 text-(--landing-canvas-mute) sm:flex-row sm:items-center sm:justify-between">
            <p>Last reviewed against public Didit documentation: August 2026.</p>
            <Link
              href="https://didit.me/pricing/"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-12 px-6 py-20 sm:px-8 sm:py-28 lg:grid-cols-[0.8fr_1.2fr] lg:px-10">
          <div>
            ...
            <h2 className="font-display mt-5 text-4xl leading-tight font-medium tracking-[-0.035em] sm:text-5xl">
              Compare decisions before moving traffic.
            </h2>
            <p className="mt-5 max-w-xl text-[15px] leading-7 text-(--landing-ink-soft)">
              Keep Didit live while HaloKYC processes a representative test
              cohort. A lower price is useful only when completion and decision
              quality still meet your bar.
            </p>
          </div>
          <ol className="grid gap-px overflow-hidden rounded-xl border border-(--landing-paper-edge) bg-(--landing-paper-edge)">
            {[
              [
                "Match one workflow",
                "Recreate its checks, minimum age, duplicate policy, and review threshold in HaloKYC.",
              ],
              [
                "Run the same test cohort",
                "Compare completion, false rejects, manual review, duplicate outcomes, and webhook handling.",
              ],
              [
                "Move one production path",
                "Cut over gradually, watch the audit trail, and keep a rollback window before moving the next flow.",
              ],
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-3xl text-lg leading-7">
                Choose HaloKYC for focused KYC, predictable credits, and
                repeat-user operations. Choose Didit when its global coverage,
                native SDKs, reusable KYC, or wider identity and fraud catalog
                matter more than the smaller operating surface.
              </p>
            </div>
          </div>
          <Link
      ...
      <section
        aria-labelledby="didit-faq-heading"
        className="border-t border-(--landing-hair) bg-(--landing-canvas-deep)"
      >
      ...
      <section className="relative overflow-hidden border-t border-(--landing-hair) bg-(--landing-canvas)">
        ...
        <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center px-6 py-24 text-center sm:px-8 sm:py-32 lg:px-10">
          <p className="font-mono text-[10px] tracking-[0.22em] text-(--landing-cyan) uppercase">
            Test the focused stack
          </p>
          <h2 className="font-display mt-5 max-w-4xl text-4xl leading-tight font-medium tracking-[-0.04em] sm:text-6xl">
            Rebuild one Didit workflow in HaloKYC.
          </h2>
          <p className="mt-6 max-w-2xl text-[15px] leading-7 text-(--landing-canvas-ink-soft)">
            Run the same cases through both products. Keep the system that gives
            your developers, reviewers, and budget the better result.
          </p>
          <div className="mt-9 flex flex-wrap justify-center gap-3">
